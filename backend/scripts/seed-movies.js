...
const movieSeedData = [
  ...
  {
    title: 'Shadow Protocol 88',
    description: 'Một đặc vụ mất trí nhớ phải lần theo dấu vết của chính mình để ngăn chặn một âm mưu tấn công quy mô lớn.',
    duration: 126,
    age_limit: 18,
    director: 'Đặng Nhật Minh',
    actors: 'Tuấn Kiệt, Bảo Anh, Lâm Vũ',
  ...
  {
    title: 'Galaxy Run: Escape Vector',
    description: 'Phi hành đoàn trẻ tuổi lao vào hành trình xuyên thiên hà để giải mã tín hiệu cứu nạn bí ẩn.',
    duration: 134,
    age_limit: 13,
    director: 'Trần Gia Hân',
    actors: 'Minh Khôi, Yến Nhi, Quốc Anh',
  ...
  {
    title: 'Little Dragon Academy',
    description: 'Cậu bé huấn luyện rồng vụng về vô tình mở ra cuộc phiêu lưu thay đổi số phận cả vương quốc.',
    duration: 101,
    age_limit: 0,
    director: 'Phan Ngọc Linh',
    actors: 'Gia Minh, Khả Hân, Thành Đạt',
  ...
  },
  {
    ...
    description: 'Một vụ mất tích tại bến cảng kéo theo hàng loạt bí mật đen tối của giới buôn lậu vùng biển phía Nam.',
    duration: 116,
    age_limit: 16,
    director: 'Lưu Hoàng Nam',
    actors: 'Hải Đăng, Thanh Trúc, Anh Vũ',
    release_date: '2026-07-05',
    status: 'now_showing',
    language: 'Tiếng Việt',
    country: 'Việt Nam',
    categories: ['Hành động', 'Tình cảm'],
  },
  {
    title: 'Moonlight Summer Letter',
    description: 'Những lá thư cũ từ mùa hè năm ấy đưa hai con người xa lạ đến gần nhau trong một chuyến về quê bất ngờ.',
    duration: 110,
    age_limit: 13,
    director: 'Võ Thu Hà',
    actors: 'Nhã Phương, Mạnh Trường, Hải Yến',
  ...
  {
    title: 'Mecha Storm Rising',
    description: 'Các chiến binh cơ giáp cuối cùng đứng lên bảo vệ thành phố nổi giữa cơn bão năng lượng chưa từng thấy.',
    duration: 129,
    age_limit: 16,
    director: 'Nguyễn Quốc Bảo',
    actors: 'Hữu Tài, Diễm My, Đức Hiếu',
  ...
  },
  {
    ...
    description: 'Một thành phố nhỏ hồi sinh ký ức qua lễ hội đèn cuối cùng, nơi những nỗi đau cũ dần được chữa lành.',
    duration: 108,
    age_limit: 0,
    director: 'Bùi Khánh Vân',
    actors: 'Lan Phương, Minh Tú, Nhật Quang',
    release_date: '2026-06-28',
    status: 'now_showing',
    language: 'Tiếng Việt',
    country: 'Việt Nam',
    categories: ['Gia đình', 'Nhạc kịch'],
  },
  {
    title: 'Echoes of Tomorrow',
    description: 'Một nhà nghiên cứu phát hiện cách gửi ký ức tới tương lai và buộc phải lựa chọn giữa tình yêu và sự thật.',
    duration: 122,
    age_limit: 13,
    director: 'Mai Thanh Phong',
    actors: 'Quỳnh Anh, Duy Khánh, Bảo Nam',
    release_date: '2026-09-22',
    status: 'coming_soon',
    language: 'Tiếng Việt',
    country: 'Việt Nam',
    categories: ['Khoa học viễn tưởng', 'Tình cảm'],
  },
];
...
const getUploadFiles = async (subfolder) => {
  ...
  return files.filter((name) => !name.startsWith('.')).sort((a, b) => a.localeCompare(b));
};
